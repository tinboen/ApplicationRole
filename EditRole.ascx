<%@ Control Language="C#" AutoEventWireup="false" Inherits="DBH.ApplicationRole.EditRole" Codebehind="EditRole.ascx.cs" %>
...
<div class="dnnForm dnnEditRole dnnClear" id="dnnEditRole">
		...
		<div class="erasContent dnnClear">
			<fieldset>
				...
				<div class="dnnFormItem" id="divBillingPeriod" runat="server">
					...
					<asp:TextBox ID="txtBillingPeriod" runat="server" MaxLength="50" Columns="10" CssClass="dnnFixedSizeComboBox" />
					<asp:DropDownList ID="cboBillingFrequency" runat="server" DataValueField="value" DataTextField="text" AutoPostBack="true" CssClass="dnnFixedSizeComboBox" AppendDataBoundItems="true">
				...
				<div class="dnnFormItem" id="divTrialPeriod" runat="server" style="z-index: 10;">
					<dnn:Label ID="plTrialPeriod" runat="server" ResourceKey="TrialPeriod" Suffix=":" ControlName="txtTrialPeriod" />
					<asp:TextBox ID="txtTrialPeriod" runat="server" MaxLength="50" Columns="10" CssClass="dnnFixedSizeComboBox" />
					<asp:DropDownList ID="cboTrialFrequency" runat="server" DataValueField="value" DataTextField="text" AutoPostBack="true" AppendDataBoundItems="true">
						<asp:ListItem Value="N" Text="NONE" />
					</asp:DropDownList>
	...
	<ul class="dnnActions dnnClear">
		...
		<li><asp:LinkButton ID="cmdUserRoles" resourcekey="cmdUserRoles" runat="server" CssClass="dnnSecondaryAction" CausesValidation="False" /></li>
